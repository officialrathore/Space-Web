...
import Wave from "../../assets/images/wave Gif.gif";
...
function Services() {
  const ServiceData = [
    ...
    },
    {
      ...
      icon: <RocketIcon className="text-7xl" />,
      aosDelay: "500",
    },
    {
      id: 3,
      ...
      icon: <RocketLaunchIcon className="text-7xl" />,
      aosDelay: "700",
    },
  ];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 relative z-50">
            {ServiceData.map((data) => (
              <div
                ...
                className="min-h-[180px] flex flex-col justify-center items-center bg-sky-900/60 rounded-xl backdrop-blur-sm text-center gap-2 text-2xl py-8 px-3 w-full lg:w-[300px] mx-auto"
              >
                {data.icon}
                <h1>{data.title}</h1>
                <p>{data.content}</p>
